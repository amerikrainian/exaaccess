namespace ExaAccess.Input
{
    ...
    /// frame by InputManager; controller bindings can be added later as a sibling.
    /// </summary>
    public abstract class InputBinding
    {
        ...
        // ---- persistence (for the future BindingSetting) ----
        ...
        // every frame and rebuilding this per binding dominated WrathAccess's per-frame allocation.
        ...
        public static InputBinding Deserialize(string type, string data)
        {
            switch (type)
            {
                case "keyboard": return SdlKeyboardBinding.Deserialize(data);
                default: return null;
            }
        }
    }
