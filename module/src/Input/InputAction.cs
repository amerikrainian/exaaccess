...
namespace Echopunks.Input
{
    ...
    /// phase state; the dispatcher routes UI-category presses into the navigator hook and fires
    /// <see cref="Performed"/> for a JustPressed that wasn't consumed.
    /// </summary>
    public class InputAction
    {
        ...
        /// <summary>Fired whenever the binding set changes (add/clear) — the future BindingSetting
        /// saves on this.</summary>
        ...
        public InputAction AddBinding(Scancode key, bool ctrl = false, bool shift = false, bool alt = false)
            => AddBinding(new SdlKeyboardBinding(key, ctrl, shift, alt));
        ...
        /// <summary>Remove one binding (a rebind capture stealing a within-category conflict).</summary>
