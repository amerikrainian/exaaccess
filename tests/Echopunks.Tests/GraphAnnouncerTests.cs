...
namespace Echopunks.Tests
{
    public class GraphAnnouncerTests
    {
        ...
        {
            // The group is ON the child's chain AND is the from-node: the prefix swallows it â€” the old
        ...
        {
            // Parts declared out of order â€” the type's kind order sorts them; the common role merges in.
            ...
            var node = new GraphNode
            {
                ...
                Vtable = new NodeVtable
                {
                    Announcements = new[]
                    {
                        ...
                        new NodeAnnouncement(() => null), // empty at speak time â€” silent
                    },
                },
            };
